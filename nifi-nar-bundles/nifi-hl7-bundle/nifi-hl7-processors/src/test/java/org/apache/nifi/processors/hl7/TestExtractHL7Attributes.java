...
public class TestExtractHL7Attributes {
    ...
    public void testExtractWithSegmentNamesAndFields() throws IOException {
        ...
        expectedAttributes.put("MSH.FieldSeparator", "|");
        expectedAttributes.put("MSH.EncodingCharacters", "^~\\&");
        expectedAttributes.put("MSH.SendingApplication.HD.NamespaceID", "XXXXXXXX");
        expectedAttributes.put("MSH.ReceivingApplication.HD.NamespaceID", "HealthProvider");
        expectedAttributes.put("MSH.MessageType.CM.MessageType", "ORU");
        expectedAttributes.put("MSH.MessageType.CM.TriggerEvent", "R01");
        expectedAttributes.put("MSH.MessageControlID", "Q1111111111111111111");
        expectedAttributes.put("MSH.ProcessingID.PT.ProcessingID", "P");
        expectedAttributes.put("MSH.VersionID", "2.3");
        expectedAttributes.put("OBR_1.SetIDObservationRequest", "1");
        expectedAttributes.put("OBR_1.PlacerOrderNumber.EI.EntityIdentifier", "341856649");
        expectedAttributes.put("OBR_1.PlacerOrderNumber.EI.NamespaceID", "HNAM_ORDERID");
        expectedAttributes.put("OBR_1.FillerOrderNumber.EI.EntityIdentifier", "000000000000000000");
        expectedAttributes.put("OBR_1.UniversalServiceIdentifier.CE.Identifier", "648088");
        expectedAttributes.put("OBR_1.UniversalServiceIdentifier.CE.Text", "Basic Metabolic Panel");
        expectedAttributes.put("OBR_1.ObservationDateTime", "20150101000000");
        expectedAttributes.put("OBR_1.OrderingProvider.XCN.IDNumber", "1620");
        expectedAttributes.put("OBR_1.OrderingProvider.XCN.FamilyName", "Johnson");
        expectedAttributes.put("OBR_1.OrderingProvider.XCN.GivenName", "Corey");
        expectedAttributes.put("OBR_1.OrderingProvider.XCN.MiddleInitialOrName", "A");
        expectedAttributes.put("OBR_1.ResultsRptStatusChngDateTime", "20150101000000");
        expectedAttributes.put("OBR_1.ResultStatus", "F");
        expectedAttributes.put("OBR_1.ScheduledDateTime", "20150101000000");
        expectedAttributes.put("OBX_1.SetIDOBX", "1");
        expectedAttributes.put("OBX_1.ValueType", "NM");
        expectedAttributes.put("OBX_1.ObservationIdentifier.CE.Identifier", "GLU");
        expectedAttributes.put("OBX_1.ObservationIdentifier.CE.Text", "Glucose Lvl");
        expectedAttributes.put("OBX_1.ObservationSubID", "59");
        expectedAttributes.put("OBX_1.ObservationValue", "mg/dL");
        expectedAttributes.put("OBX_1.Units.CE.Identifier", "65-99");
        expectedAttributes.put("OBX_1.Units.CE.NameOfCodingSystem", "65");
        expectedAttributes.put("OBX_1.Units.CE.NameOfCodingSystem", "99");
        expectedAttributes.put("OBX_1.ReferencesRange", "L");
        expectedAttributes.put("OBX_1.NatureOfAbnormalTest", "F");
        expectedAttributes.put("OBX_1.UserDefinedAccessChecks", "20150102000000");
        expectedAttributes.put("PD1.PatientPrimaryCareProviderNameIDNo.XCN.IDNumber", "1234567890");
        expectedAttributes.put("PD1.PatientPrimaryCareProviderNameIDNo.XCN.FamilyName", "LAST");
        expectedAttributes.put("PD1.PatientPrimaryCareProviderNameIDNo.XCN.GivenName", "FIRST");
        expectedAttributes.put("PD1.PatientPrimaryCareProviderNameIDNo.XCN.MiddleInitialOrName", "M");
        expectedAttributes.put("PD1.PatientPrimaryCareProviderNameIDNo.XCN.AssigningAuthority", "NPI");
        expectedAttributes.put("PID.PatientIDInternalID.CX.ID", "12345");
        expectedAttributes.put("PID.PatientIDInternalID.CX.AssigningAuthority", "XYZ");
        expectedAttributes.put("PID.PatientIDInternalID.CX.IdentifierTypeCode", "MR");
        expectedAttributes.put("PID.PatientName.XPN.FamilyName", "SMITH");
        expectedAttributes.put("PID.PatientName.XPN.GivenName", "JOHN");
        expectedAttributes.put("PID.DateOfBirth", "19700100");
        expectedAttributes.put("PID.Sex", "M");
        expectedAttributes.put("PID.PatientAccountNumber.CX.ID", "111111111111");
        expectedAttributes.put("PID.SSNNumberPatient", "123456789");
